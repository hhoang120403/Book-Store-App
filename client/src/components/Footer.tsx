  ...
  return (
    <footer className='max-padd-container bg-gradient-to-l from-primary via-white to-primary'>
      <div className='flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-gray-500/30'>
        <div>
          ...
          <p className='max-w-[410px] mt-6'>
            Discover a wide collection of books across all genres — from
            timeless classics to the latest bestsellers. Dive into stories,
            expand your knowledge, and enjoy reading experiences crafted for
            every book lover.
          </p>
        </div>
      ...
      <p className='py-4 text-center'>
        Copyright 2025 © JayT All Right Reserved.
      </p>
    </footer>
  );
};
