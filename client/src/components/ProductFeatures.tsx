        ...
        <div className='flexCenter gap-x-4 p-2 rounded-3xl'>
          ...
          <div>
            ...
            <p>
              ...
              Perferendis incidunt sed voluptatum dolores quisquam saepe,
              cupiditate, molestiae fugiat voluptate a obcaecati error animi,
              libero illo inventore itaque id veniam accusantium.
            </p>
          </div>
        </div>
        <div className='flexCenter gap-x-4 p-2 rounded-3xl'>
          ...
          <div>
            ...
            <p>
              ...
              numquam harum, sit dolorem unde atque repellat, aliquam officiis,
              optio cupiditate minus. Sed optio aut recusandae minima ipsam
              maxime blanditiis accusantium!
            </p>
          </div>
        </div>
        <div className='flexCenter gap-x-4 p-2 rounded-3xl'>
          <div className='text-3xl'>
            <RiSecurePaymentLine className='mb-3 text-red-500' />
          </div>
          <div>
